...
| Oyun | Açıklama | Route |
|---|---|---|
| **VoxelCraft** ⛏️ | Minecraft tarzı hayatta kalma: prosedürel arazi, can/açlık, envanter (E), 2×2/3×3 üretim, aletler+dayanıklılık, kazı/inşa | `/game-hub/games/voxelcraft` |
